...
const Welcome: React.FC = () => {
  ...
  return (
    <div  className="flex   flex-col h-[600px] items-start justify-center max-w-screen-2xlw-screen pt-32 p-5">
      ...
      <h2 className="text-xl pulse text-gray-600 dark:text-gray-400 mb-10">Connecting Agriculture for a Better Tomorrow</h2>
      <div className="text-xl pulse text-gray-700 dark:text-gray-300 text-start mb-6">
        ...
        <Link to="/login" className="w-full md:w-auto light-speed-in">
        ...
        <Button variant="outline" className="md:w-auto w-full px-4 py-2 light-speed-in" onClick={handleLearnMoreClick}>
